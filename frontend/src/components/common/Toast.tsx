...
/**
 * ToastContainer with ARIA live regions for screen reader accessibility
 * Uses role="status" for informational toasts and role="alert" for errors
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* Action button for error recovery (retry, etc.) */}
        {toast.action && (
          <button
            onClick={() => {
            ...
            className="mt-2 text-xs font-medium px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 transition-colors"
          >
            {toast.action.label}
          </button>
        )}
